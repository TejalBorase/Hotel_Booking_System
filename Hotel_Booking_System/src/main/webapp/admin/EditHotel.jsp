...
<head>
    ...
    <style>
        ...
        margin: 0;
        padding: 0;
        background-image: url("https://owall-hotel-seoul.booked.net/data/Photos/OriginalPhoto/6643/664358/664358145/Owall-Hotel-Seoul-Exterior.JPEG");
              ...
              <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                      <li><a class="dropdown-item" href="/gotoAddHotel">Add Hotel</a></li>
                      <li><a class="dropdown-item" href="/gotoHotelList">Hotel List</a></li>
                    </ul>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
    ...
    <div class="container  w-50 p-3 m-5">
        <div class="row justify-content-left">
          <div class="col-md-8">
              ...
              <form th:action="@{/hotel/{id}(id=${hotel.id})}"  method="post">
                  <div class="row mb-3">
                      <div class="col">
                          <label for="hotelname" class="form-label">Hotel Name :</label>
                          <input type="text" class="form-control"  placeholder="Hotel Name" th:field="*{hotelname}" required >
                      </div>
                      <div class="col">
                          <label for="contact" class="form-label">Contact Number :</label>
                          <input type="text" class="form-control" placeholder="Contact Number " th:field="*{contactnumber}"   required >
                      </div>
                  </div>
                  <div class="row mb-3">
                      <div class="col">
                          <label for="price" class="form-label">Price :</label>
                          <input type="number" class="form-control"  placeholder="Enter Price"  th:field="*{price}"  required >
                      </div>
                      <div class="col">
                        <label for="city" class="form-label">City :</label>
                        <input type="text" class="form-control" placeholder="Enter City"  th:field="*{city}" required >
                    </div>	
                  </div>
                  <div class="row mb-3">
                      <div class="col">
                          <label for="address" class="form-label">Address :</label>
                          <input type="text" class="form-control"  placeholder="Enter Address" th:field="*{address}"  required >
                      </div>
                      <div class="col">
                   ...
                   <button type="submit" class="btn btn-outline-dark">ADD HOTEL</button> 
